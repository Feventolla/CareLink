    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.title}>
          {currentLanguage.language === 'en' ? "Let's Get Started" : 'ወደ መተግበሪያው ይግቡ'}
        </Text>
        <Text style={styles.subTitle}>

          {currentLanguage.language === 'en' ? "Create Your new Account" : 'አዲስ መለያዎን ይፍጠሩ'}
        </Text>
        <View style={styles.form}>
          <Text style={styles.label}>{currentLanguage.language === 'en' ? 'First Name' : 'የመጀመሪያ ስም'}</Text>
          <TextInput
            placeholder={currentLanguage.language === 'en' ? "Enter your Firstname" : 'የመጀመሪያ ስምዎን ያስገቡ'}
          ...
          <Text style={styles.label}>{currentLanguage.language === 'en' ? 'Last Name' : 'የአባት ስም'}</Text>
          <TextInput
            placeholder={currentLanguage.language === 'en' ? "Enter your Lastname" : 'የአባት ስምዎን ያስገቡ'}
            keyboardType="default"
          ...
          <Text style={styles.label}>{currentLanguage.language === 'en' ? "Pasword" : 'የይለፍ ቃልዎ'}</Text>
          <TextInput
            placeholder={currentLanguage.language === 'en' ? "Enter your password" : 'የይለፍ ቃልዎን ያስገቡ'}
          ...
          <Text style={styles.label}>{currentLanguage.language === 'en' ? 'Gender' : 'ጾታ'}</Text>
          ...
          <Text style={styles.label}>{currentLanguage.language === 'en' ? 'Age' : 'እድሜ'}</Text>

          <TextInput
            placeholder={currentLanguage.language === 'en' ? "Enter your Age" : 'እድሜህን አስገባ'}
          ...
          <Text style={styles.label}>{currentLanguage.language === 'en' ? "Weight" : 'ክብደት'}</Text>
          <TextInput
            placeholder={currentLanguage.language === 'en' ? "Enter your Weight" : 'ክብደትህን አስገባ'}
            keyboardType="number-pad"
          ...
          <Text style={styles.label}>{currentLanguage.language === 'en' ? "Height" : 'ቁመት'}</Text>
          <TextInput
            placeholder={currentLanguage.language === 'en' ? "Enter your Height" : 'ቁመትህን አስገባ'}
            keyboardType="number-pad"
          ...
          <Text style={styles.label}>{currentLanguage.language === 'en' ? "Photo" : 'ፎቶ'}</Text>
          <View style={styles.file}>
            <TouchableOpacity onPress={pickImage}>
              <Text style={styles.picktext}>{currentLanguage.language === 'en' ? " Pick Image" : 'ፎቶ ምረጥ'}</Text>
            </TouchableOpacity>
            {selectedImage && (
      ...
      <View style={styles.bottombutton}>
        <TouchableOpacity style={styles.button} onPress={handleRegister}>
          <Text style={styles.buttonText}>{currentLanguage.language === 'en' ? "Register" : 'ይመዝገቡ'}</Text>
        </TouchableOpacity>
        ...
        >
          <Text style={styles.footerText}>
            {currentLanguage.language === 'en' ? "Already Have an account" : 'አስቀድሞ መለያ አለዎት'}?{" "}
            <Text style={styles.logincolor}>{currentLanguage.language === 'en' ? "Login" : 'ግቡ'}</Text>
          </Text>
        </TouchableOpacity>
      </View>
    </View>
