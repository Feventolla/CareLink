      ...
      <div className="flex flex-row flex-wrap gap-6">
        {loop.map((i) => (
          <div
            key={i}
            role="status"
            className="max-w-2xl p-4 border border-gray-200 rounded shadow animate-pulse md:p-6"
          >
            <div className="flex items-center self-center justify-center mb-4 bg-gray-300 rounded w-16 h-12 mx-auto">
              <svg
                className="w-10 h-10 text-gray-200 justify-center"
                aria-hidden="true"
